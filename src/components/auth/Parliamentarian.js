...
const Parliamentarian = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (authcode != "154-098-235") {
      throwToast(
        "error",
        "Your authorization code is incorrect, you are not allowed to sign up as a Parliamentarian."
      );
      return;
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(Parliamentarian);
